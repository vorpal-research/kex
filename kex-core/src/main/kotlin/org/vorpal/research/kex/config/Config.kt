...
abstract class Config {
    ...
    open fun getPathValue(section: String, name: String, default: String): Path =
        getStringValue(section, name, default).let { Paths.get(it) }

    open fun getPathValue(section: String, name: String, default: Path): Path =
        getStringValue(section, name)?.let { Paths.get(it) } ?: default
